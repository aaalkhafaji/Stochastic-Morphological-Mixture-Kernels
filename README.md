...
## Step 10 execution-ready campaign

The repository now includes `.github/workflows/step10-generalization-calibration.yml` and `code/run_step10_generalization.py`. Step 10 freezes Oxford-trained models and evaluates cross-domain transfer to official DAVIS 2016 genuine segmentation errors without DAVIS refitting, direct-output probability calibration and selective risk, and computational scaling over image sizes 64–480 and bank sizes 7–63. Results are not claimed until the GitHub Actions artifact is audited.
