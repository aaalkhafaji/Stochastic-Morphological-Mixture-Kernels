...
### SoftMorph2 (runtime-only Step 8 comparator)
Step 8 may retrieve the public SoftMorph2 repository from https://github.com/lisaGUZZI/SoftMorph2 at workflow runtime to validate the independent product-logic implementation. The SoftMorph2 source is not redistributed in this package. Users should consult the upstream repository and publication for applicable rights and terms.
